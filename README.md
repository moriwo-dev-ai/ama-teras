...
**[📥 AMA-teras Setup 1.0.0.exe をダウンロード](https://github.com/moriwo-dev-ai/ama-teras/releases/download/v1.0.0/AMA-teras.Setup.1.0.0.exe)**(Windows・約102MB・管理者権限不要)

最新版は [Releases](https://github.com/moriwo-dev-ai/ama-teras/releases) から。
