...
export default {
  ...
  description:
    ...
    '【建築の掟(M167)】建築物はすべて「開ける」— ラベル付きオブジェクトはタップ=名札・ダブルタップ=口が開く(エンジン標準・追加作業不要)。' +
    '機能を持たせたい建築物には**同じ名前(label)で app_add** すれば自動リンクされ、ダブルタップでそのアプリが起動する。' +
    '先に空アプリ(「準備中」ページ等)を作っておき、あとから中身を実装してもよい。新しい建築物には必ずlabelを付けること。' +
