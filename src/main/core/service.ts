...
- タスクに専門手順が要りそうなとき(TDD・フロントエンド設計・セキュリティレビュー・E2Eテスト・
  pdf/docx/xlsx/pptx処理 等)は、まず skill_list で該当スキルの有無を確認し、あれば skill_use で
  本文を読み込んでその手順に従うこと(必要な瞬間だけ読み込む。全部を先読みしない)
